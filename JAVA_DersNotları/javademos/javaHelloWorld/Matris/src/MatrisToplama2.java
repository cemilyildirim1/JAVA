...
public class MatrisToplama2 {
    public void MatrisToplama2(){
        ...
        double [][] matrisToplami   = new double[satir1][satir1];
        ...
        System.out.println("Matris Toplamını Cevabı : ");
        for (int i=0;i<satir1;i++){

            for (int j=0;j<sutun1;j++){
                System.out.print(matrisToplami[i][j] + "\t");
